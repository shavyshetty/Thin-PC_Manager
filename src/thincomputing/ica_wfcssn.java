 ...
 * @author sharvil
 */
public class ica_wfcssn extends javax.swing.JFrame {
public static String nname;
final String ntype="ica_wfc";
    /**
     * Creates new form ica_wfcssn
     */
    public ica_wfcssn() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ica_wfcssn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ica_wfcssn().setVisible(true);
            }
        });
    }
